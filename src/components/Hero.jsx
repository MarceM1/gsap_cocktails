...
const Hero = () => {
  ...
  useGSAP(() => {
    ...
    const paragraphSplit = new SplitText(".subtitle", { tpye: "lines" });
    ...
    const endValue = isMobile ? "120% top" : "bottm top";
  ...
  return (
    <>
      ...
      <div className="video absolute inset-0 border-2 border-blue-500">
		<video
		 ref={videoRef}
		 muted
		 playsInline
